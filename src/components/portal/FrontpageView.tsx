  ...
  const rawBentoNewsItems = React.useMemo(() => {
    ...
    const ABOUT_ADJUNG_GROUPS: Record<string, Array<{ desk: string; topik: string; title: string; brief: string; briefLong: string }>> = {
      ...
      STANDARD: [
        ...
        { desk: 'Kandungan', topik: 'Status', title: 'Kandungan Bergerak Antara Aktif, Menunggu dan Arkib', brief: 'Kandungan terbitan sama ada Aktif atau Arkib selepas digantikan; kedua-duanya tidak boleh dipadam, berbeza daripada draf yang masih boleh dibuang.', briefLong: 'Setiap kandungan yang telah diterbitkan berada dalam salah satu status: Aktif jika sedang dipaparkan pada slotnya, atau Arkib jika telah digantikan oleh kandungan lebih baharu tetapi rekodnya masih disimpan. Kandungan yang sudah pernah terbit, sama ada Aktif atau Arkib, tidak boleh dipadam terus daripada sistem kerana ia sebahagian daripada sejarah penerbitan. Draf yang belum pernah diterbitkan berbeza sifatnya dan boleh dibuang oleh penulisnya sendiri. Ticker dikecualikan daripada peraturan ini kerana kandungannya ditarik secara langsung daripada suapan RSS luar.' },
        { desk: 'Editorium', topik: 'Peranan', title: 'Empat Peranan Mengendalikan Bilik Editorial', brief: 'Penulis mencipta draf, Editor menyunting dan menghantar, Ketua Editor meluluskan penerbitan, manakala Penolong membantu tugas mengikut kebenaran yang diberikan.', briefLong: 'Bilik editorial Adjung Brief dikendalikan oleh empat peranan berlainan. Penulis mencipta dan menyimpan draf tanpa kuasa menerbitkan terus. Editor menyunting kandungan dan menghantarnya untuk disiarkan, sama ada terus jika mempunyai kebenaran terbit, atau melalui semakan jika tidak. Ketua Editor memegang kuasa penuh meluluskan, menolak dan menetapkan Bidang bagi setiap slot. Penolong Ketua Editor membantu tugas penyemakan mengikut kebenaran yang diberikan oleh Ketua Editor. Setiap peranan melihat Editorium dengan susun atur dan kebenaran yang berbeza mengikut tanggungjawab masing-masing.' },
      ],
      SEGI_EMPAT_MEDIUM: [
      ...
      SEGI_EMPAT_SMALL: [
        ...
        { desk: 'Peraturan', topik: 'Padam vs Arkib', title: 'Draf Boleh Padam, Terbitan Cuma Arkib', brief: 'Pernah aktif tidak dipadam.', briefLong: 'Draf yang belum pernah diterbitkan sepenuhnya milik penulisnya dan boleh dipadam terus tanpa kesan kepada rekod lain. Berbeza dengan kandungan yang pernah tersiar, sama ada masih Aktif mahupun sudah Arkib, kerana ia dianggap sebahagian daripada sejarah penerbitan Adjung Brief yang perlu dikekalkan. Kandungan sebegini hanya boleh diarkibkan, bukan dipadam, supaya jejak penerbitan tetap boleh disemak kembali pada bila-bila masa. Ticker dikecualikan daripada peraturan ini kerana kandungannya ditarik terus daripada suapan RSS luar.' },
      ],
      KOMPAK: [
        { desk: 'Editorium', topik: 'Draf Saya', title: 'Draf Saya Menyimpan Kandungan Sebelum Dihantar', brief: '', briefLong: 'Draf Saya menyimpan kandungan sebelum dihantar untuk semakan. Editor boleh menulis, menyimpan dan menyunting semula draf pada bila-bila masa sebelum menghantarnya. Apabila kandungan yang dihantar ditolak, ia tidak hilang — ia dipulangkan sebagai draf supaya boleh disunting semula dan dihantar sekali lagi. Draf dikenal pasti sebagai milik seseorang penulis melalui tanda "Penulis:" pada teksnya. Apabila draf akhirnya diterbitkan, ia bertukar menjadi kandungan sebenar lengkap dengan Bidang, Topik dan sejarah versi.' },
        { desk: 'Paparan', topik: 'Label Kad', title: 'Label Kad Memaparkan Bidang Diikuti Topik', brief: '', briefLong: 'Setiap kad pada muka depan memaparkan label ringkas di bahagian atas, disusun sebagai Bidang diikuti Topik, dipisahkan dengan tanda garis kecil apabila kedua-duanya wujud. Kandungan lama yang wujud sebelum medan Topik diperkenalkan hanya memaparkan Bidang sahaja, tanpa cuba mengagak atau mengisi Topik yang tiada. Warna label mengikuti warna Bidang induknya, supaya kandungan daripada Bidang yang sama kelihatan konsisten walaupun Topiknya berbeza-beza antara satu kad dengan yang lain di seluruh muka depan.' },
        { desk: 'Kandungan', topik: 'Medan', title: 'Setiap Kandungan Menggunakan Set Medan yang Sama', brief: '', briefLong: 'Tidak kira Bidang atau tier kadnya, setiap kandungan editorial membawa set medan yang sama: tajuk, huraian, huraian panjang, sumber, pautan dan Topik. Editor mengisi medan ini melalui borang yang sama di Editorium, tidak kira sekecil mana kad yang akan memaparkannya. Sesetengah medan tidak dipaparkan pada kad tertentu kerana ruangnya terhad, tetapi ia tetap disimpan dan boleh dibaca sepenuhnya dalam Focus View. Keseragaman medan ini membolehkan sistem menyemak bajet ruang dan memaparkan kandungan secara konsisten merentasi lapan tier kad.' },
      ],
      BAR: [
