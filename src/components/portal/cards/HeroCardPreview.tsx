  ...
  return (
    ...
    <div className="p-4 md:p-8 relative rounded-lg shadow-sm flex flex-col gap-3 min-h-[180px]" style={tema.cardStyle}>
      <BentoInner itemKey="pratonton-hero" className="md:flex-row md:items-center justify-between gap-6">
        ...
        <span className="font-sans text-[7px] md:text-[10px] tracking-editorial uppercase text-stone-300 border-t pt-2 md:border-t-0 md:border-l md:pt-0 border-stone-400/30 md:pl-4 flex-shrink-0 md:self-stretch flex flex-col justify-center gap-1" style={tema.sourceStyle}>
