...
interface MaklumanDrawerProps {
  ...
  // kandungan secara manual?"). Percubaan PERTAMA tambah butang "Padam semua yang telah dibaca"
  // — Izzat tolak: "jangan 'padam semua'... skrg awak cuma bg satu pilihan: kekalkan semua, atau
...
const IKON_JENIS: Record<string, React.ReactNode> = {
  ...
  // Permohonan editor baharu (2026-08-25, permohonanEditorRoutes.js, borang awam "Sertai
  // Pasukan Editorial") — corak IDENTIK bug sistem_permohonan_penaja di atas, terlepas daripada
  // peta ni sejak ciri tu dibina, ditemui+dibaiki serentak semasa audit 2026-09-02.
  sistem_permohonan_editor: <UserPlus className="w-2.5 h-2.5" />,
};
...
const LABEL_JENIS: Record<string, string> = {
  ...
  sistem_permohonan_editor: 'Sistem: Permohonan Editor',
};
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* Padam satu-satu (2026-08-16, Izzat: "buat butang pangkah untuk setiap
                            mesej... editor boleh padam sendiri" — percubaan pertama sorok-lalai/
